// The screens of the page (.slide) and the progress indicator that lists them: one tick per screen, the current one in
// the accent, a click to go there. Built here rather than written in the page: without JavaScript it would lead nowhere.
